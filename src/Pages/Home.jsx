...
/* ===== Icônes inline ===== */
const LogoPF = () => (
  <div className="h-8 w-8 rounded-md bg-orange-600 grid place-items-center text-white font-black">
    PF
  </div>
);
const SparkIcon = () => (
      ...
      <header className="sticky top-0 z-10 border-b border-orange-100/50 bg-white/75 backdrop-blur">
        <div className="mx-auto max-w-6xl h-16 px-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            ...
            <button className="grid h-9 w-9 place-items-center rounded-full border border-gray-200 hover:bg-gray-50">
              ⟳
            </button>
          </div>
        </div>
      ...
      <main className="mx-auto max-w-6xl px-4 py-8">
        ...
        <section className="rounded-2xl bg-white shadow-sm ring-1 ring-orange-100 p-6 md:p-8 grid md:grid-cols-2 gap-6">
          <div className="self-center">
            ...
            {/* ✅ Le bouton renvoie maintenant vers /tests/complet */}
            <Link
              to="/tests/complet"
          ...
          <div className="overflow-hidden rounded-2xl">
            <img
              ...
              src={imageHome}
              alt="Illustration orientation professionnelle"
            />
          </div>
        </section>
        ...
        <section className="mt-6 grid gap-4 md:grid-cols-2">
          <div className="rounded-xl bg-white ring-1 ring-gray-200 p-4 flex items-center gap-4">
            <div className="h-10 w-10 grid place-items-center rounded-xl bg-orange-50 text-orange-600 text-xl">
              ◎
            </div>
            <div>
              <div className="text-2xl font-semibold">0</div>
              <div className="text-sm text-gray-600">Tests complétés</div>
            </div>
          </div>

          <div className="rounded-xl bg-white ring-1 ring-gray-200 p-4 flex items-center gap-4">
            <div className="h-10 w-10 grid place-items-center rounded-xl bg-indigo-50 text-indigo-600">
              <SparkIcon />
            </div>
            <div>
              <div className="text-2xl font-semibold">0</div>
              <div className="text-sm text-gray-600">Métiers explorés</div>
            </div>
          </div>
        </section>
          ...
          {[
            {
              ...
              desc: "Prends 15-20 min pour répondre honnêtement aux questions."
            },
            {
              step: 2,
              title: "Découvre ton profil",
              desc: "Obtiens immédiatement ton profil détaillé."
            },
            {
              step: 3,
              title: "Explore les métiers recommandés",
              desc: "Consulte les métiers les plus compatibles avec toi."
            }
          ].map(({ step, title, desc }) => (
            <div
              key={step}
              className="rounded-2xl bg-white ring-1 ring-gray-200 p-5 flex items-start gap-4"
            >
